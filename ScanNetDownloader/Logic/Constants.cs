...
namespace ScanNetDownloader.Logic
{
    ...
    public class Constants
    {
        ...
        public const string ANIMESAMA_DOMAIN_NAME = "https://anime-sama.to";
        public const string ANIMESAMA_IMG_URL_START = "https://anime-sama.to/s2/scans/";
        ...
        public static readonly Dictionary<string, List<string>> EXAMPLE_URLS = new Dictionary<string, List<string>>()
        {
            ...
            { ANIMESAMA_DOMAIN_NAME, new List<string>()
                {
                    "https://anime-sama.to/catalogue/one-piece/scan_noir-et-blanc/vf/ (for scan in french)",
                    "https://anime-sama.to/catalogue/one-piece/scan_noir-et-blanc/va/ (for scan in english)"
                }
            },
